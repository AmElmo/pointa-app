...
By installing, accessing, or using Pointa (the "Software"), including the Chrome browser extension and the pointa-server npm package, you agree to be bound by these Terms and Conditions. If you do not agree to these terms, do not use the Software.

## 2. License Grant

Pointa is licensed under the MIT License. Subject to your compliance with these terms, you are granted a non-exclusive, worldwide, royalty-free license to use, copy, modify, and distribute the Software in accordance with the MIT License terms.

## 3. Description of Service

Pointa is a developer tool that:
...
### 4.1 Data Storage
- All annotation data is stored locally on your machine in `~/.pointa/`
- The Chrome extension uses Chrome Storage API for local data persistence
- No data is transmitted to external servers or third parties

### 4.2 Network Communications
- The extension communicates only with your local server (port 4242)
...
You agree to use Pointa only for:
...
You agree NOT to use Pointa for:
...
Pointa facilitates integration with AI coding agents (Claude Code, Cursor, Windsurf, etc.) but:
...
By contributing to Pointa on GitHub, you:
...
- Pointa name and logo are property of Raphael Regnier/Spellbind Creative Studio
...
- GitHub Issues: https://github.com/RaphaelRegnier/pointa/issues
- Author: Raphael Regnier - Spellbind Creative Studio

## 16. Acknowledgment

By using Pointa, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.
